                ...
                <div>
                    ...
                    <div class="space-y-6">
                        <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm">
                            ...
                            <a class="block text-sm text-primary font-medium hover:underline mb-1" href="mailto:sales@sigsolresmenu.com">sales@sigsolresmenu.com</a>
                            <p class="text-sm text-slate-600 dark:text-slate-400">+234 (0) 812 345 6789</p>
                        </div>
                        <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm">
                            <div class="size-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary mb-4">
                            ...
                            <a class="block text-sm text-primary font-medium hover:underline mb-1" href="mailto:support@sigsolresmenu.com">support@sigsolresmenu.com</a>
                            <p class="text-sm text-slate-600 dark:text-slate-400">+234 (0) 701 987 6543</p>
                        </div>
                        <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm">
                            <div class="size-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary mb-4">
                            ...
                            <a class="block text-sm text-primary font-medium hover:underline mb-1" href="mailto:partners@sigsolresmenu.com">partners@sigsolresmenu.com</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-4 space-y-10">
                <div class="space-y-8">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h4 class="font-bold text-slate-900 dark:text-white mb-1">Lagos HQ</h4>
                            <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                                12 Adeola Odeku Street, Victoria Island,<br/>
                ...
                <div class="relative w-full rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-lg">
                    <div class="bg-slate-100 dark:bg-slate-800 aspect-[4/5] relative">
                        ...
                        <div class="absolute bottom-6 left-6 right-6 bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm p-5 rounded-xl shadow-2xl border border-primary/20">
                            ...
                            <p class="text-xs text-slate-500 dark:text-slate-400 mb-4">Serving over 500+ restaurants across 3 continents.</p>
                            <a href="<?php echo htmlspecialchars($baseUrl); ?>/restaurants-list.php" class="block w-full py-2 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white text-xs font-bold rounded-lg text-center hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
                                <span class="material-symbols-outlined text-sm align-middle">public</span> View Global Directory
                            </a>
                        </div>
                    </div>
                </div>
                <div class="space-y-4 pt-4">
                    ...
                    <div class="flex gap-4">
                        <a class="size-10 rounded-full border border-slate-200 dark:border-slate-700 flex items-center justify-center hover:bg-primary hover:text-white hover:border-primary transition-all" href="#" aria-label="Facebook">
                        ...
                        <a class="size-10 rounded-full border border-slate-200 dark:border-slate-700 flex items-center justify-center hover:bg-primary hover:text-white hover:border-primary transition-all" href="#" aria-label="Twitter">
                        ...
                        <a class="size-10 rounded-full border border-slate-200 dark:border-slate-700 flex items-center justify-center hover:bg-primary hover:text-white hover:border-primary transition-all" href="#" aria-label="Instagram">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            msg.classList.add('bg-green-100', 'text-green-800', 'dark:bg-green-900/30', 'dark:text-green-200');
