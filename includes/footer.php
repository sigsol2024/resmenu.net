...
<ul class="space-y-4 text-slate-400">
<li><a class="hover:text-primary transition-colors" href="<?php echo htmlspecialchars($baseUrl); ?>/faq.php">FAQ</a></li>
<li><a class="hover:text-primary transition-colors" href="<?php echo htmlspecialchars($baseUrl); ?>/terms.php">Terms of Service</a></li>
<li><a class="hover:text-primary transition-colors" href="<?php echo htmlspecialchars($baseUrl); ?>/contact.php">Contact Us</a></li>
